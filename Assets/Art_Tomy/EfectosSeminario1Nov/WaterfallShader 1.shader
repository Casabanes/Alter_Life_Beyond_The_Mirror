...
Shader "WaterfallShader"
{
	Properties
	{
		...
		_Velocidadrotation("Velocidad rotation", Float) = 0.2
	...
	SubShader
	{
		...
		uniform float _Velocidadrotation;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mulTime269 = _Time.y * _Velocidadrotation;
			...
			float2 uv_TexCoord353 = i.uv_texcoord * float2( 1,1 );
			float temp_output_10_0_g7 = uv_TexCoord353.x;
			float CantEspuma12_g7 = _Bordefoam;
			float IntEspuma16_g8 = _Intensidadfoam;
			float temp_output_10_0_g8 = uv_TexCoord353.y;
			float CantEspuma12_g8 = _Bordefoam;
			float temp_output_316_0 = saturate( ( ( step( simplePerlin2D283 , _Stepfoam ) * ( ( _Intensidadpartenegrafoam * distance( uv_TexCoord340 , _Distance ) ) - _Partenegrafoam ) ) + ( ( ( IntEspuma16_g7 * ( ( 1.0 - temp_output_10_0_g7 ) - CantEspuma12_g7 ) ) * ( IntEspuma16_g7 * ( CantEspuma12_g7 - temp_output_10_0_g7 ) ) ) + ( ( IntEspuma16_g8 * ( ( 1.0 - temp_output_10_0_g8 ) - CantEspuma12_g8 ) ) * ( IntEspuma16_g8 * ( CantEspuma12_g8 - temp_output_10_0_g8 ) ) ) ) ) );
			float Foam350 = saturate( temp_output_316_0 );
...
/*ASEBEGIN
Version=18301
-5;664;1352;539;1473.074;-1014.756;2.312619;True;False
Node;AmplifyShaderEditor.CommentaryNode;373;-512.8767,729.8854;Inherit;False;2472.053;1513.694;Foam;41;336;337;335;273;268;269;340;334;342;267;372;290;341;345;266;343;353;292;283;367;368;347;346;291;348;371;315;316;374;375;381;383;384;386;389;392;393;388;395;398;397;;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector2Node;372;-292.3432,1460.094;Inherit;False;Property;_Tilingbordeybrillo;Tiling borde y brillo;22;0;Create;True;0;0;False;0;False;1,1;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;336;-348.1659,896.1922;Inherit;False;Property;_Flowmapfoam;Flowmap foam;24;0;Create;True;0;0;False;0;False;1;0.91;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;268;-136.8764,1169.344;Inherit;False;Property;_Velocidadrotation;Velocidad rotation;12;0;Create;True;0;0;False;0;False;0.2;0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;331;-427.2747,124.9516;Inherit;False;Property;_TilingUVAgua;Tiling UV Agua;20;0;Create;True;0;0;False;0;False;0.2,0.2;0.25,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;342;142.6783,1575.03;Inherit;False;Property;_Distance;Distance;14;0;Create;True;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;210;-234.4888,-602.0685;Inherit;False;Property;_Distanciabrillo;Distancia brillo;8;0;Create;True;0;0;False;0;False;0.5,0.5;0.41,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;403;-411.9645,1766.911;Inherit;False;Constant;_Vector2;Vector 2;29;0;Create;True;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;345;226.7106,1359.044;Inherit;False;Property;_Intensidadpartenegrafoam;Intensidad parte negra foam;27;0;Create;True;0;0;False;0;False;6.98;3.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;290;357.2804,1214.842;Inherit;False;Property;_Scalenoisefoam;Scale noise foam;17;0;Create;True;0;0;False;0;False;2.96;3.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;165;1.13836,30.33318;Inherit;False;Property;_Velocidadpanneo;Velocidad panneo;7;0;Create;True;0;0;False;0;False;0.15;1.35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;326;-194.9034,-238.5973;Inherit;False;Property;_Flowmapaguaintensidad;Flowmap agua intensidad;21;0;Create;True;0;0;False;0;False;0.025;0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;214;-12.57469,-445.6833;Inherit;False;Property;_StepBrillo;Step Brillo;10;0;Create;True;0;0;False;0;False;0.5;-16.16;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;292;632.2801,1271.842;Inherit;False;Property;_Stepfoam;Step foam;18;0;Create;True;0;0;False;0;False;0.45;0.39;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;368;-188.0795,2063.905;Inherit;False;Property;_Intensidadfoam;Intensidad foam;26;0;Create;True;0;0;False;0;False;3.24;2.86;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;353;-258.666,1850.145;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;367;-199.5655,1981.02;Inherit;False;Property;_Bordefoam;Borde foam;23;0;Create;True;0;0;False;0;False;0.81;0.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;347;624.3763,1647.794;Inherit;False;Property;_Partenegrafoam;Parte negra foam;28;0;Create;True;0;0;False;0;False;1.77;1.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;398;55.08503,1794.133;Inherit;True;FunctionBordes;-1;;7;1c664b9ff265ee24793fb26eaf19ab3b;0;3;10;FLOAT;0;False;11;FLOAT;0;False;15;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;140;269.2718,302.0157;Inherit;False;Property;_Coloraguafondo;Color agua fondo;25;0;Create;True;0;0;False;0;False;0.1066661,0.3028149,0.4811321,0;0.1722143,0.2546798,0.8113208,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;397;55.14936,2014.269;Inherit;True;FunctionBordes;-1;;8;1c664b9ff265ee24793fb26eaf19ab3b;0;3;10;FLOAT;0;False;11;FLOAT;0;False;15;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;121;268.4898,132.1444;Inherit;False;Property;_Coloraguaarriba;Color agua arriba;15;0;Create;True;0;0;False;0;False;0.1826273,0.4412826,0.6792453,1;0.2409665,0.4164107,0.8962264,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;249;216.0699,-471.0206;Inherit;False;Property;_Substractbrillo;Substract brillo;11;0;Create;True;0;0;False;0;False;2.93;-1.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;231;510.0956,-538.1548;Inherit;False;Property;_Colorbrillo;Color brillo;9;0;Create;True;0;0;False;0;False;0.4245283,0.4225258,0.4225258,0;0.7924528,0.7139551,0.7139551,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;297;2220.01,672.723;Inherit;False;Property;_Colorfoam;Color foam;19;0;Create;True;0;0;False;0;False;0.8820755,1,0.968103,0;0.8867924,0.8867924,0.8867924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;383;1514.289,1889.937;Inherit;False;Property;_Scaletextfoam;Scale text foam;30;0;Create;True;0;0;False;0;False;-1.54;-1.54;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;392;1163.521,1893.279;Inherit;False;Property;_Panningtextfoam;Panning text foam;31;0;Create;True;0;0;False;0;False;0,1;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;388;1035.518,2014.318;Inherit;False;Property;_Velocidadtextfoam;Velocidad text foam;32;0;Create;True;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;395;1733.639,2020.364;Inherit;False;Property;_Intensidadtextfoam;Intensidad text foam;29;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A61DAF5465C5FB6ACE2C8358F396FEE1711C0094